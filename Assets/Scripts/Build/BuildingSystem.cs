...
public class BuildingSystem : MonoBehaviour
{
    ...
    void Update()
    {
        if (isBuildingMode && currentPreviewObject != null)
        {
            ...
            {
                GameObject newBuilding = Instantiate(currentBuildingPrefab, buildPosition, Quaternion.Euler(0, 0, currentRotation));
            }
        }
    ...
    {
        Collider2D[] hitColliders = Physics2D.OverlapBoxAll(position, buildingSize, 0f, collisionLayerMask);
